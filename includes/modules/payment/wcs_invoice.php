...
class wcs_invoice_ORIGIN extends WirecardCheckoutSeamless
{
    ...
    function consentCheckbox()
    {
        ...
        $field = "<input class='form-control' type='checkbox' name='wcs_invoice_payolution_terms' />";
    ...
    public function pre_confirmation_check()
    {
        if ($_POST['payment'] == 'wcs_invoice') {
            ...
            if (MODULE_PAYMENT_WCS_INVOICE_PAYOLUTION_CONSENT == "on" && $_POST['wcs_invoice_payolution_terms'] !== 'on') {
