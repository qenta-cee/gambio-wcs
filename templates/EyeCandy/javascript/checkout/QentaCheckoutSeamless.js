		...
		init: function () {
			...
			if (typeof WirecardCEE_DataStorage !== "undefined") {
				...
				if ($('#qcsIframeContainerqcs_ccard').length > 0) {
					this.pci3Iframes.CCARD = wdcee.buildIframeCreditCard('qcsIframeContainerqcs_ccard', '600px', '200px');
					wdcee.onIframeClick(self.handleIframeClick);
				} else if ($('#qcsIframeContainerqcs_ccardmoto').length > 0) {
					this.pci3Iframes.CCARD = wdcee.buildIframeCreditCard('qcsIframeContainerqcs_ccardmoto', '600px', '200px');
					wdcee.onIframeClick(self.handleIframeClick);
				}
			}
