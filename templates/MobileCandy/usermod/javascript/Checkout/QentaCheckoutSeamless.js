		...
		init: function () {
			...
			if (typeof WirecardCEE_DataStorage !== "undefined") {
				...
				if ($('#qcsIframeContainerqcs_ccard').length > 0) {
					this.pci3Iframes.CCARD = wdcee.buildIframeCreditCard('qcsIframeContainerqcs_ccard', '262px', '203px');
					wdcee.onIframeClick(self.handleIframeClick);
				} else if ($('#qcsIframeContainerqcs_ccardmoto').length > 0) {
					this.pci3Iframes.CCARD = wdcee.buildIframeCreditCard('qcsIframeContainerqcs_ccardmoto', '262px', '200px');
					wdcee.onIframeClick(self.handleIframeClick);
				}
			}
